-- Initial schema for dark-rs database layer
-- Supports both PostgreSQL and SQLite

-- Rounds table
CREATE TABLE IF NOT EXISTS rounds (
    id                  TEXT PRIMARY KEY,
    starting_timestamp  INTEGER NOT NULL DEFAULT 0,
    ending_timestamp    INTEGER NOT NULL DEFAULT 0,
    ...
    vtxo_tree_expiration INTEGER NOT NULL DEFAULT 0,
