...
//! ## Architecture
//!
//! The wallet service implements the [`WalletService`](dark_core::ports::WalletService)
//! trait from dark-core, enabling clean separation between the core domain logic
...
//!
//! ```rust,no_run
//! use dark_wallet::{WalletConfig, WalletManager, WalletServiceImpl};
//! use std::sync::Arc;
//!
//! #[tokio::main]
...
//!
//! ```rust,no_run
//! use dark_wallet::coin_selection::{CoinSelector, CoinSelectionStrategy};
//! use bitcoin::Amount;
//! # let utxos: Vec<dark_wallet::WalletUtxo> = vec![];
//!
