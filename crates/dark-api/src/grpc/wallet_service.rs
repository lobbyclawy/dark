...
mod tests {
    ...
    impl WalletService for MockWallet {
        async fn status(&self) -> ArkResult<dark_core::ports::WalletStatus> {
            Ok(dark_core::ports::WalletStatus {
                initialized: true,
                unlocked: true,
                synced: true,
            })
        ...
        async fn select_utxos(
            ...
            _: u64,
            _: bool,
        ) -> ArkResult<(Vec<dark_core::ports::TxInput>, u64)> {
            unimplemented!()
        }
        ...
        async fn get_current_block_time(&self) -> ArkResult<dark_core::ports::BlockTimestamp> {
            unimplemented!()
        }
